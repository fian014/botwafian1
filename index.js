const  XBOT = 'FianDev14'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/fian_014'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6281331954019'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://m.youtube.com/channel/UCoRe-nP3qQZsN6QCniov5bw'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:FianDev14\n' // full name
            + 'ORG:Owner  PatrickStar;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6281331954019:+62 813-3195-4019\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] PatrickStar Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @FianDev14`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @FianDev14`)
})
...
conn.sendMessage(id, 'Aku BOT nya fian' ,MessageType.text);
}
else if (text == 'audio'){
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  PatrickStar, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  PatrickStar, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id,  PatrickStar, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#foto'){
